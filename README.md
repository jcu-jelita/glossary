...
1. Otevře se úvodní okno s vytvořenými knihovnami s možností (1.1) spuštění, (1.2) editace knihovny a smazání celé knihovny. Pod výčtem knihoven se nachází tlačítko s možností přidání nové knihovny (1.3). 
